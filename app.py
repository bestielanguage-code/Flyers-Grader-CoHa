...
try:
    ...
    # Tự động nhận diện: Online dùng Secrets, Local dùng file key.json
...
# --- 2. CẤU HÌNH AI GEMINI (Fix lỗi 404) ---
# Online lấy từ Secrets, Local lấy từ mã trực tiếp
        ...
        if name and writing:
            with st.spinner("Cô Hà đang xem kỹ bài..."):
                try:
                    ...
                    2. Feedback: Viết cực ngắn gọn 3 mục (KHÔNG HTML, KHÔNG LIST):
                    ...
                    """
                    # Dùng model gemini-1.5-flash-latest để ổn định nhất, không bị lỗi 404
                    ...
                    if match:
                        ...
                        # Hiển thị bản sửa lỗi với nền tối cho chuyên nghiệp
